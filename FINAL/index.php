    ...
    <section class="landing-hero">
        ...
        <div class="container text-center">
            ...
            <p class="hero-subtitle">
                Browse upcoming events from top organizers. Technology, Business, Education, Sports &amp; more — all in one place.
            </p>
            ...
            <?php else: ?>
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-custom glass-card landing-event-card h-100 d-flex flex-column fade-in"
                             style="animation-delay: <?php echo ($index % 9) * 0.05; ?>s;">
